  ...
  return (
    <Html>
      <Head>
        ...
        <Preview>Recebemos uma solicitação para redefinir a senha da sua conta {appName}</Preview>
      </Head>
      <Body style={StyleSheet.body}>
        <Container style={StyleSheet.container}>
          ...
          <Text>
            Pedido de redefinição de senha recebido. Clique no botão abaixo para confirmar a redefinição de senha.
          </Text>
